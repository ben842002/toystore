...
$db       = 'ben84200_toystore';            // Name of the database
$port     = '3306';                         // Port is usually 3306 in Hostgator
$charset  = 'utf8mb4';                      // UTF-8 encoding using 4 bytes of data per char

$username = 'ben84200_ben842002';       // Enter YOUR cPanel username and user here
$password = 'csc_100712532';            // Enter YOUR user password here
